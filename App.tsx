...
import { Calendar, MapPin, User, Star, Mic, PenTool, Mail, Facebook, Instagram, Send, Download, Camera, ExternalLink, Map, Twitter, MessageCircle } from 'lucide-react';
...
de l'Association des Bédéistes du Cameroun (ABC).` },
  { id: '4', name: 'Remi Damien X. DECAVEL', country: 'France', role: 'Auteur', imageUrl: IMAGES.DECAVEL, bio: `Tout petit, je dévorais des BD et des dessins animés. Cette passion ne
m'a jamais quitté et a naturellement orienté mon parcours vers la
création. Après une formation en design puis en animation, j'ai
travaillé plusieurs années comme animateur 2D, notamment à
Angoulême. Désireux de transmettre cette passion, j'ai créé un
atelier de bande dessinée dans un centre social. Aujourd'hui, je
collabore avec des associations et la Cité internationale de la bande dessinée et de l'image à
Angoulême, tout en développant mes projets. J'explore mes idées dans différents formats,
toujours guidé par cet amour du dessin et de la narration.` },
...
function App() {
  ...
  return (
    <div className="min-h-screen font-comic-body text-gray-900 overflow-x-hidden relative pt-20">
      ...
      {/* --- HERO SECTION --- */}
      <section id="home" className="relative bg-fibeg-orange py-20 px-4 border-b-4 border-black overflow-hidden">
        {/* Background Elements */}
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="mt-12 flex flex-col md:flex-row gap-4 justify-center items-center flex-wrap">
            ...
            <a
              href="./media/programme_fibeg_2025.pdf"
              download
      ...
      {/* --- GUESTS SECTION --- */}
      <section id="guests" className="py-20 px-4 bg-white border-y-4 border-black relative">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          {/* Local Authors List - Now "Galerie Bulle d'Encre" */}
          <div className="mt-24">
      ...
      {/* --- GALLERY SECTION --- */}
      <section id="gallery" className="py-20 px-4 bg-fibeg-yellow border-b-4 border-black">
      ...
      {/* --- CONFERENCES --- */}
      <section id="conferences" className="py-20 px-4 max-w-5xl mx-auto">
      ...
      {/* --- PARTNERS --- */}
      <section id="partners" className="py-20 px-4 bg-white border-t-4 border-black">
        <div className="max-w-6xl mx-auto text-center">
           <h2 className="text-4xl font-comic-header mb-12 uppercase">Nos Précieux Partenaires</h2>
           
           {/* VIPs */}
           <div className="grid md:grid-cols-2 gap-8 mb-12">
              <ComicCard className="bg-yellow-50">
                <h3 className="font-comic-header text-xl mb-2">Sous le parrainage de</h3>
                <p className="font-bold text-lg">Mourana SOUMAH & Fatoumata Foulá DIALLO</p>
              </ComicCard>
              <ComicCard className="bg-blue-50">
                <h3 className="font-comic-header text-xl mb-2">Ministères</h3>
                <p className="font-bold text-lg">Moussa Moïse SYLLA (Culture) & Fana SOUMAH (Information)</p>
              </ComicCard>
           </div>
           ...
           <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {partners.map((partner, idx) => (
                <div key={idx} className="bg-white border-2 border-gray-300 p-4 flex items-center justify-center hover:shadow-lg transition-all duration-300 ease-in-out hover:scale-110 group">
                  <img src={partner.logo} alt={partner.name} className="max-h-16 max-w-full object-contain filter grayscale group-hover:grayscale-0 transition-all duration-300 ease-in-out opacity-60 group-hover:opacity-100" />
                </div>
              ))}
           </div>
        </div>
      ...
      {/* --- CONTACT & REGISTER --- */}
      <section id="contact" className="py-20 px-4 bg-fibeg-dark text-white border-t-4 border-black">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center mb-12 max-w-3xl mx-auto">
            {/* Contact Info */}
              ...
              <div className="bg-gray-800 p-6 border-2 border-gray-600 rounded-lg mb-8 w-full">
              ...
              <div className="flex gap-4">
                <a href="www.facebook.com/fibeg2025" className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform border-2 border-white">
                  <Facebook size={24} />
                </a>
                <a href="https://whatsapp.com/channel/0029Vb7eJCm30LKGUfXGQC2j" className="w-12 h-12 bg-pink-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform border-2 border-white">
                  <Instagram size={24} />
                </a>
                <a href="www.facebook.com/fibeg2025" className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center hover:scale-110 transition-transform border-2 border-white">
                  <Send size={24} />
                </a>
              </div>
          </div>
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
    <div className="bg-fibeg-dark/80 p-6 rounded-xl border-2 border-gray-600 backdrop-blur-sm relative z-10">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="mt-6 inline-block px-6 py-2 bg-white text-black font-comic-header text-lg rounded-full hover:bg-fibeg-yellow transition-colors"
      >
    ...
    <div className="absolute inset-0 opacity-20 pointer-events-none bg-[url('https://images.unsplash.com/photo-1524661135-423995f22d0b?q=80&w=1200&auto=format&fit=crop')] bg-cover bg-center filter grayscale contrast-150"></div>
  </div>
</div>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-4">
        ...
        <div className="flex flex-col gap-3">
           ...
           <a 
              href="www.facebook.com/fibeg2025" 
